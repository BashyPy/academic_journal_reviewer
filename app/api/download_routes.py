...
async def download_original_manuscript(
    submission_id: str,
    ...
    try:
        ...
        logger.error(e, additional_info={"submission_id": submission_id, "user_id": user.get("user_id")})
...
async def download_review_pdf(
    ...
    try:
        ...
        safe_name = "".join(c for c in base_name if c.isalnum() or c in (" ", "-", "_")).strip() or "manuscript"
