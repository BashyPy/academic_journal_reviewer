...
class TestSpecialistAgents:
    ...
    def test_methodology_agent(self, mock_llm):
        ...
        mock_llm.call_llm.return_value = "Methodology analysis: The study design is appropriate"
    ...
    def test_clarity_agent(self, mock_llm):
        ...
        mock_llm.call_llm.return_value = "Clarity analysis: Writing is clear and concise"
        agent = ClarityAgent()
...
class TestOrchestrator:
    ...
    def test_process_submission_success(self, mock_synthesis, mock_detector, mock_db):
        ...
        mock_synthesis_instance.synthesize_reviews = AsyncMock(return_value="final report")
