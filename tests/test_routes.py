...
class TestAPIEndpoints:
    ...
    def test_upload_manuscript_success(
        self, mock_orchestrator, mock_parser, mock_db, client, sample_pdf_content
    ):
    ...
    def test_get_status_success(self, mock_db, client):
        ...
        mock_db.get_agent_tasks = AsyncMock(
            return_value=[{"agent_type": "methodology", "status": "completed"}]
        )
